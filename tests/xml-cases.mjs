...
export const cases = [
    ...
    { name: 'unsupported xrechnung profile', edit: x => x.replace('urn:cen.eu:en16931:2017', 'urn:cen.eu:en16931:2017#compliant#urn:xeinkauf.de:kosit:xrechnung_3.0'), status: 'unsupported' },
